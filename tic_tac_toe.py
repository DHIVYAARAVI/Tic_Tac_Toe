...
#Creating a function to disable the button
...
#Creating a function to check the person who won
def checkwon():
    global winner
    winner = False
...
def button(b):
    ...
    if b['text'] == ' ' and clicked == True:
        ...
        messagebox.showerror('Tic Tac Toe', 'Hey! The box is already fixed\nSo pick up another box')
